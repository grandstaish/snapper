...
import nz.bradcampbell.snapper.internal.Util.GenericArrayTypeImpl;
import nz.bradcampbell.snapper.internal.Util.ParameterizedTypeImpl;
import nz.bradcampbell.snapper.internal.Util.WildcardTypeImpl;
...
import static nz.bradcampbell.snapper.internal.Util.EMPTY_TYPE_ARRAY;
import static nz.bradcampbell.snapper.internal.Util.getGenericSupertype;
import static nz.bradcampbell.snapper.internal.Util.resolve;

/**
 * Factory methods for types.
 */
@SuppressWarnings({ "unused", "WeakerAccess" }) public final class Types {
  private Types() {
  }
  ...
  static Type[] mapKeyAndValueTypes(Type context, Class<?> contextRawType) {
    // Work around a problem with the declaration of java.internal.Properties. That class should extend
